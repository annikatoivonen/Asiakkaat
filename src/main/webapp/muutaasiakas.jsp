...
<form id="tiedot">
	<table>
		<thead>
			...
			<th colspan="2" class="oikealle"><a href="listaaasiakkaat.jsp" id="takaisin">Takaisin listaukseen</a>
			</tr>
			<tr>
				<th>Etunimi</th>
				<th>Sukunimi</th>
		...
		<tbody>
			<tr>
				...
				<td><input type="button" id="tallenna" value="Hyväksy" onclick="muutaTiedot()"></td>
			</tr>
		</tbody>
	</table>
